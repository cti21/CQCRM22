    ...
    <div>
        ...
        <el-row style="margin:20px;">
          ...
          >
            ...
            <el-table-column prop="flag" label="是否传染病区" width="180">
            </el-table-column>
            <el-table-column prop="comment" label="备注" width="280" show-overflow-tooltip>
            </el-table-column>
        ...
        <div>
          <el-dialog  title="病区管理" width="40%" :visible.sync="dialogFormVisible">
                  <el-form  :model="area" ref="dataForm" :rules="rules"  label-position="left" label-width="120px" style='width:90%; margin-left:30px;'>
                       ...
                       <el-row>
                         <el-col>
                            <el-form-item label="是否传染病区"  prop="flag">
                              <el-select v-model="area.flag" clearable style="width: 200px" class="myInput">
                      ...
                      <el-row>
                         <el-col>
                            ...
                            <el-input type="textarea" v-model="area.comment" style="width: 380px;" class="myInput"></el-input>
                            </el-form-item>
                          </el-col>
                      </el-row>
                  </el-form>
...
<script>
import { diseaseArea, createDiseaseArea, updateDiseaseArea, deleteDiseaseArea } from '@/api/system'
  ...
  data: function() {
    return {
      ...
      rules: {
        ...
        flag: [{ required: true, message: '请选择病区的种类', trigger: 'blur' }]
      },
      area: {
        id: null,
        name: '',
  ...
  methods: {
    ...
    createData() {
      this.$refs.dataForm.validate((valid) => {
        if (valid) {
          ...
          createDiseaseArea(this.area).then(() => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          updateDiseaseArea(tempData).then(() => {
            this.dialogFormVisible = false
            this.$notify({
              title: '成功',
              message: '更新成功',
    ...
    handleDelete(row) {
      this.$confirm('确认删除该记录吗?', '提示', {
        ...
        this.area = Object.assign({}, row) // copy obj
        const tempData = Object.assign({}, this.area)
        deleteDiseaseArea(tempData).then(() => {
          this.$notify({
            title: '成功',
            message: '删除成功',
            type: 'success',
