    ...
    <div>
        ...
        <el-row style="margin:20px;">
          ...
          >
            ...
            <el-table-column prop="benefitname" label="名称" width="180">
            </el-table-column>
        ...
        <div>
          <el-dialog  title="中心工资福利" width="40%" :visible.sync="dialogFormVisible">
...
<script>
import { benefits, benefit_dicts, createBenefit, deleteBenefit } from '@/api/system'
...
export default {
  ...
  methods: {
    ...
    getDept_dict(data) {
      benefit_dicts(data).then(response => {
