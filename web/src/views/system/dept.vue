    ...
    <div>
        ...
        <el-row style="margin:20px;">
          ...
          >
            ...
            <el-table-column prop="name" label="中心" width="180">
            </el-table-column>
...
<script>
import { dept_dicts, depts, createDept, deleteDept } from '@/api/system'
