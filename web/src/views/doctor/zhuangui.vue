<template>
    <div>
        <div class="filter-container">
              <!--<el-input-->
                <!--v-model="searchname"-->
                <!--class="myInput" style="width: 220px;margin-right: 20px"-->
                <!--placeholder="请输入转归类型">-->
              <!--</el-input>-->
              <!--<el-button-->
                <!--size="small"-->
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="date" label="转归日期" width="120" align="center">
            </el-table-column>
            <el-table-column prop="leixing" label="转归类型" width="120" align="center">
            </el-table-column>
            <el-table-column prop="yuanyin" label="转归原因" width="160" align="center">
            </el-table-column>
            <el-table-column prop="otherreason" label="其他原因" width="160" align="center">
            </el-table-column>
            <el-table-column prop="comment" label="备注" width="160" align="center">
            </el-table-column>
