<template>
             ...
             <div>
               ...
               <el-card style="width: 90%">
                  <div slot="header" class="clearfix">
                      ...
                      <el-button
                        type="primary"
                        style="float: right;padding-top: 8px;margin-top: -5px;margin-right: 50px"
                        @click="handleCreate"
                        size="mini"
                        icon="el-icon-plus"
                      >新增
               ...
               <el-card>
                    <div slot="header" class="clearfix">
                        ...
                        <el-button
                          size="mini"
                          type="success"
                          v-if="tx_plan.state !== 1"
                          style="float: right;padding-top: 8px;margin-top: -5px;margin-right: 50px"
                          icon="el-icon-check"
                          @click="confirm_txplan">确认
                        </el-button>
                        <el-button
                          size="mini"
                          type="primary"
                        ...
                        <el-row type="flex">
                          ...
                          <el-col :span="8">
                             <el-form-item label="干体重:" prop="gantizhong">
                                <el-input v-model.number="tx_plan.gantizhong"   class="myInput" style="width:160px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="周频次:" prop="week">
                                <el-input v-model.number="tx_plan.week"  class="myInput" style="width:180px"></el-input>
                              </el-form-item>
                           </el-col>
                         </el-row>
                         <el-row type="flex">
                           <el-col :span="8">
                             <el-form-item label="次数:" prop="times" >
                                <el-input v-model.number="tx_plan.times" class="myInput" style="width:180px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="钙(mmol/l):" prop="ca" >
                                <el-input v-model.number="tx_plan.ca"  class="myInput" style="width:150px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="钾(mmol/l):" prop="k" >
                                <el-input v-model.number="tx_plan.k"  class="myInput" style="width:160px"></el-input>
                              </el-form-item>
                           </el-col>
                         </el-row>
                         <el-row type="flex">
                           <el-col :span="8">
                             <el-form-item label="钠(mmol/l):" prop="na" >
                                <el-input v-model.number="tx_plan.na"  class="myInput" style="width:140px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="碳酸氢根(mmol/l):" prop="hco3" >
                                <el-input v-model.number="tx_plan.hco3"  class="myInput" style="width:110px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="透析液流量(ml/mimn):" prop="touxiyeliuliang" >
                              <el-input v-model.number="tx_plan.touxiyeliuliang"  class="myInput" style="width:100px"></el-input>
                              </el-form-item>
                           </el-col>
                         </el-row>
                         <el-row type="flex">
                           <el-col :span="8">
                             <el-form-item label="血流量(ml/mimn):" prop="xueliuliang" >
                                <el-input v-model.number="tx_plan.xueliuliang"  class="myInput" style="width:100px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="抗凝剂类型:" prop="kangning">
                                <el-select v-model="tx_plan.kangning" clearable style="width: 160px" class="myInput">
                           ...
                           <el-col :span="8">
                             <el-form-item label="首剂(mg):" prop="shouji" >
                                <el-input v-model.number="tx_plan.shouji"  class="myInput" style="width:180px"></el-input>
                              </el-form-item>
                           </el-col>
                         </el-row>
                         <el-row>
                           <el-col :span="8">
                             <el-form-item label="追加(mg/h):" prop="zhuijia" >
                                <el-input v-model.number="tx_plan.zhuijia"  class="myInput" style="width:150px"></el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="8">
                             <el-form-item label="总量(mg/h):" prop="total" >
                                <el-input v-model.number="tx_plan.total"  class="myInput" style="width:160px"></el-input>
                              </el-form-item>
                           </el-col>
                         </el-row>
                    </el-form>
      ...
      <div style="margin-top: 20px">
        <el-card style="width: 90%">
          <div slot="header" class="clearfix">
            ...
            <el-checkbox style="float: right;margin-top: 5px;margin-right: 50px" v-model="checked">套餐</el-checkbox>
            <el-button
              type="primary"
              style="float: right;padding-top: 8px;margin-right: 50px;margin-top: -5px"
              @click="tcCreate"
              size="mini"
              icon="el-icon-plus"
            >新增</el-button>
          ...
          <el-table
            ...
            <el-table-column label="操作" fixed="right"  align="center">
              <template slot-scope="scope">
                  <el-button size="small" type="text" @click="tcUpdate(scope.row)">
                    修改
                  </el-button>
                  <el-button size="small" type="text" @click="tcDelete(scope.row)">
                    删除
                  </el-button>
              </template>
            </el-table-column>
      ...
      <div>
          <el-dialog  title="新增医嘱" width="60%" :visible.sync="dialogListVisible">
            ...
            <div slot="footer" class="dialog-footer" style="margin-right: 40px">
              <el-button size="mini" type="primary" @click="submitData" icon="el-icon-check">提交</el-button>
              <el-button size="mini" @click="dialogListVisible = false" icon="el-icon-close">关闭</el-button>
            </div>
          </el-dialog>
        </div>
      ...
      <div>
        <el-dialog  title="编辑医嘱" width="50%" :visible.sync="tc_dialogVisible">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button size="mini" @click="tc_dialogVisible = false" icon="el-icon-close">关闭</el-button>
                <el-button size="mini" type="primary" @click="tcUpdateData" icon="el-icon-check">保存</el-button>
            </div>
        </el-dialog>
    </div>
    ...
    <div>
      <el-dialog  title="添加医嘱套餐" width="40%" :visible.sync="dialogFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
              <el-button size="mini" @click="dialogFormVisible = false" icon="el-icon-close">关闭</el-button>
              <el-button size="mini" type="primary"  @click="taocanCreateData" icon="el-icon-check">保存</el-button>
            </div>
      </el-dialog>
    </div>
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm('确认删除该记录吗?', '提示', {
        ...
        this.tx_plan = Object.assign({}, row)
        const tempData = Object.assign({}, this.tx_plan)
