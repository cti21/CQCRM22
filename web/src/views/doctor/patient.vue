    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="patientid" label="患者编号" width="90"  align="center">
            </el-table-column>
            <el-table-column prop="sex" label="性别" width="80"  align="center">
            </el-table-column>
            <el-table-column prop="age" label="年龄" width="80"  align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="phone1" label="电话" width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="adddate" label="添加日期" width="120" align="center" :formatter="dateFormat">
            </el-table-column>
            <el-table-column prop="id" v-if="false">
            </el-table-column>
            <el-table-column prop="address" label="地址" width="120" align="center" show-overflow-tooltip>
            </el-table-column>
            <el-table-column label="操作" fixed="right" align="center">
              <template slot-scope="scope">
                  <el-button type="text" size="small" @click="handleUpdate(scope.row)">修改</el-button>
                  <el-button type="text" size="small" @click="handleDelete(scope.row)">删除</el-button>
                  <el-button type="text" size="small" @click="handleDetail(scope.row)">电子病历</el-button>
              </template>
            </el-table-column>
          </el-table>
        ...
        <div>
          <el-dialog  title="医生小结" width="35%" :visible.sync="dialogFormVisible">
                  <el-form  :model="tc" ref="dataForm"   label-position="left" label-width="20px" style='width:90%;margin-top: 10px;margin-left:10px;'>
                      <el-row>
                         <el-col>
                            <el-form-item  prop="doctorcomment">
                              <el-input type="textarea" v-model="tc.doctorcomment"  class="myInput"></el-input>
                            </el-form-item>
                          </el-col>
                      </el-row>
                  </el-form>
...
<script>
import { updatejiaobanpatient } from '@/api/doctor'
import { patients } from '@/api/login'
