<template>
    <div>
        <!--<el-row>-->
            <!--<el-button size="small" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-plus">-->
              <!--新建分部-->
            <!--</el-button>-->
        <!--</el-row>-->
        <el-row style="margin:20px;">
          ...
          >
            ...
            <el-table-column prop="web" label="网址" width="220">
            </el-table-column>
        ...
        <div>
          <el-dialog  title="总部信息" width="40%" :visible.sync="dialogFormVisible">
                       ...
                       <el-row>
                         <el-col>
                            <el-form-item label="网址"  prop="web">
                              <el-input v-model="area.web" style="width: 380px;" class="myInput"></el-input>
                            </el-form-item>
                         </el-col>
                       </el-row>
                  </el-form>
...
<script>
import { Companys, updateCompany } from '@/api/login'
...
export default {
  ...
  created: function() {
    console.log('nodeOject', this.nodeOject)
    this.queryparams.page = 1
    this.queryparams.name = ''
    this.getCompany(this.queryparams)
  }
