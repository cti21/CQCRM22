    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="name" label="耗材名称" width="180" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="spec" label="规格" width="100" align="center">
            </el-table-column>
            <el-table-column prop="units" label="单位" width="80" align="center">
            </el-table-column>
            ...
            <el-table-column prop="jieyu" label="结余" width="100" align="center" show-overflow-tooltip>
            </el-table-column>
          </el-table>
...
<script>
import { getMaterialStock } from '@/api/login'
...
export default {
  ...
  methods: {
    getStockList(data) {
      getMaterialStock(data).then(response => {
    ...
    handleFilter() {
      ...
      this.queryparams.type = this.matSelect
      this.getStockList(this.queryparams)
    },
