        ...
        <el-container style="border: 1px solid #eee;">
          <el-aside width="300px" style="border: 1px solid #eee;background-color: #ffffff">
              ...
              <el-table
                ...
                <el-table-column prop="patientid" label="编号" width="70"  align="center">
                </el-table-column>
                <el-table-column prop="balance" label="金额" width="80"  align="center">
                </el-table-column>
              </el-table>
...
import expenseDetail from '@/components/page/expense.vue'
