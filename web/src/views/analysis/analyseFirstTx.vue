    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="touxidate" label="透析日期" align="center" :formatter="dateFormat">
            </el-table-column>
            <el-table-column prop="bingliid" label="病历号" align="center">
            </el-table-column>
            <el-table-column prop="tx_no" label="透析号" align="center">
            </el-table-column>
            <el-table-column prop="name" label="姓名" align="center">
            </el-table-column>
            <el-table-column prop="source" label="来源" align="center">
            </el-table-column>
            <el-table-column prop="address" label="家庭住址" align="center" width="180px" show-overflow-tooltip>
            </el-table-column>
          </el-table>
        </div>
    </div>
...
import { analyseFirstTx } from '@/api/analysis'
...
export default {
  ...
  methods: {
    getAnalyseFirstTx(data) {
      analyseFirstTx(data).then(response => {
    ...
    handleReset() {
      ...
      this.searchEndyear = ''
      this.getAnalyseFirstTx(this.queryparams)
    },
    handleFilter() {
