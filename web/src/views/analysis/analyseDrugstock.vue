    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            id="outTable"
            border>
            <el-table-column type="index" label="次数"  width="60" align="center">
            </el-table-column>
            <el-table-column prop="name" label="品名" align="center">
            </el-table-column>
            <el-table-column prop="spec" label="规格" align="center">
            </el-table-column>
            <el-table-column prop="units" label="单位" align="center">
            </el-table-column>
            <el-table-column label="期初库存" align="center">
                <el-table-column prop="qcnum" label="数量" align="center">
                </el-table-column>
                <el-table-column prop="qcjine" label="金额" align="center">
                </el-table-column>
            </el-table-column>
            <el-table-column label="本期购进" align="center">
                <el-table-column prop="gjnum" label="数量" align="center">
                </el-table-column>
                <el-table-column prop="gjjine" label="金额" align="center">
                </el-table-column>
            </el-table-column>
            <el-table-column label="本期发出" align="center">
                <el-table-column prop="fcnum" label="数量" align="center">
                </el-table-column>
                <el-table-column prop="fcjine" label="金额" align="center">
                </el-table-column>
            </el-table-column>
            <el-table-column label="本期结余" align="center">
                <el-table-column prop="jynum" label="数量" align="center">
                </el-table-column>
                <el-table-column prop="jyjine" label="金额" align="center">
                </el-table-column>
            </el-table-column>
          </el-table>
        </div>
...
import { analyseDrugstock } from '@/api/analysis'
...
export default {
  ...
  methods: {
    getAnalyseDrugstock(data) {
      analyseDrugstock(data).then(response => {
    ...
    handleReset() {
      ...
      this.searchEndyear = ''
      this.getAnalyseDrugstock(this.queryparams)
    },
    handleFilter() {
