    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="feetype" label="收费类型" width="140" align="center">
            </el-table-column>
            <el-table-column prop="name" label="收费项目" width="220">
            </el-table-column>
            <el-table-column prop="operateDate" label="收费日期" width="120" align="center" :formatter="dateFormat">
            </el-table-column>
            <el-table-column prop="rcptno" label="票据号" align="center" width="200">
            </el-table-column>
            <el-table-column prop="price" label="单价" align="center" width="110">
            </el-table-column>
            <el-table-column prop="count" label="数量" align="center" width="110">
            </el-table-column>
            <el-table-column prop="jine" label="金额" align="center" width="110">
            </el-table-column>
          </el-table>
        </div>
    </div>
...
import { analyseDeptCharge } from '@/api/analysis'
...
export default {
  ...
  methods: {
    getAnalyseDeptCharge(data) {
      analyseDeptCharge(data).then(response => {
    ...
    handleReset() {
      ...
      this.searchEndyear = ''
      this.getAnalyseDeptCharge(this.queryparams)
    },
    handleFilter() {
    ...
    exportExcel() {
      ...
      try {
        FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '科室收费统计.xlsx')
      } catch (e) {
