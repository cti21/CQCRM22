<template>
    <div>
        <div class="filter-container">
              ...
              <el-button size="mini" style="margin-left: 20px" type="primary"  @click="handleFilter" icon="el-icon-search">搜索</el-button>
              <el-button size="mini" style="margin-left: 20px"type="primary" @click="handleReset" icon="el-icon-download">重置</el-button>
              <el-button size="mini" style="margin-left: 20px"type="success" @click="exportExcel" icon="el-icon-upload">导出</el-button>
        </div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="bedname" label="床号" align="center">
            </el-table-column>
            <el-table-column prop="patientname" label="透析患者" align="center">
            </el-table-column>
            <el-table-column prop="executedate" label="医嘱时间" align="center">
            </el-table-column>
            <el-table-column prop="drugname" label="医嘱项目" align="center">
            </el-table-column>
