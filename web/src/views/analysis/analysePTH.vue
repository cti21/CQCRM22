    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="leibie" label="类别" align="center">
            </el-table-column>
             <el-table-column prop="num" label="PTH人次" align="center">
            </el-table-column>
          </el-table>
        </div>
    </div>
...
import { analysePTH } from '@/api/analysis'
