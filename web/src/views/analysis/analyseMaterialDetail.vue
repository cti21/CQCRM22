          ...
          <el-main>
            <div style="margin-top: 0px">
              <el-table
                ...
                <el-table-column prop="patientname" label="透析患者" width="120" align="center">
                </el-table-column>
...
import { analysematerial, analysematerialDetail } from '@/api/analysis'
...
export default {
  ...
  methods: {
    getAnalysematerial(data) {
      analysematerial(data).then(response => {
    ...
    getAnalysematerialDetail(data) {
      analysematerialDetail(data).then(response => {
    ...
    handleReset() {
      ...
      this.Endyear = ''
      this.getAnalysematerial(this.queryparams)
    },
    handleFilter() {
    ...
    rowClick(row, event, column) {
      ...
      this.getAnalysematerialDetail(this.queryparams)
    },
