<template>
    <div>
        <div class="filter-container">
              <el-date-picker v-model="searchyear" type="month" class="myInput" placeholder="请输入年月" value-format="yyyy-MM">
              </el-date-picker>
...
import { TxtypeBymonth } from '@/api/analysis'
...
export default {
  ...
  methods: {
    getTxtypeBymonth(data) {
      TxtypeBymonth(data).then(response => {
    ...
    handleReset() {
      ...
      this.searchyear = ''
      this.getTxtypeBymonth(this.queryparams)
    },
    handleFilter() {
