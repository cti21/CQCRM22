    ...
    <div>
        ...
        <div style="margin-top: 20px">
          <el-table
            ...
            <el-table-column prop="nursecomment" label="护理小结" width="180" align="center">
            </el-table-column>
            <el-table-column prop="doctorcomment" label="医生小结" width="180" align="center">
            </el-table-column>
            <el-table-column prop="comment" label="透析小结" width="180" align="center">
            </el-table-column>
        ...
        <div>
          <el-dialog  title="护士小结" width="45%" :visible.sync="dialogFormVisible">
                  <el-form  :model="tc" ref="dataForm" label-position="left" label-width="10px" style='margin-top: 10px;'>
                      <el-row>
                         <el-col>
                            <el-form-item prop="nursecomment">
                              <el-input type="textarea" v-model="tc.nursecomment" style="width: 100%;"></el-input>
                            </el-form-item>
                          </el-col>
                      </el-row>
                  </el-form>
...
<script>
import { jiaobanNurse, updatejiaobanNurse } from '@/api/nurse'
...
export default {
  ...
  methods: {
    getJiaobanpatient(data) {
      jiaobanNurse(data).then(response => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          tempData.doctorcomment = 'aaa'
          tempData.state = 2
          updatejiaobanNurse(tempData).then(() => {
