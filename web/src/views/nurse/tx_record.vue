             ...
             <div style="margin-top:10px">
                <el-card style="width: 90%">
                    ...
                    <el-form  :model="tx_rec" :rules="rules" ref="postForm"  label-position="left" style='margin-left:25px;' size="small">
                      <el-row>
                           <el-col :span="6">
                              <el-form-item label="实际治疗时间" prop="sj_time">
                                 <div>{{tx_rec.sj_time}}</div >
                              </el-form-item>
                           </el-col>
                           <el-col :span="6">
                             <el-form-item label="实际超滤总量" prop="sj_chaolv_volume" >
                               <el-input
                          ...
                          <el-col :span="6">
                              <el-form-item label="透后体重" prop="th_weight" >
                                 <el-input v-model.number="tx_rec.th_weight"  class="myInput" style="width:50px;">
                                 </el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="6">
                              <el-form-item label="体重下降" prop="tz_xiajiang" >
                                   <el-input v-model.number="tx_rec.tz_xiajiang"  class="myInput" style="width:50px;">
                                   </el-input>
                              </el-form-item>
                           </el-col>
                      </el-row>
                      <el-row>
                          <el-col :span="6">
                              <el-form-item label="体温(度)" prop="th_tiwen" >
                                  <el-input v-model.number="tx_rec.th_tiwen"  class="myInput" style="width:50px;">
                                  </el-input>
                              </el-form-item>
                           </el-col>
                          <el-col :span="6">
                              <el-form-item label="心率(次/min)" prop="th_xinlv" >
                                  <el-input v-model.number="tx_rec.th_xinlv"  class="myInput" style="width:50px;">
                                  </el-input>
                              </el-form-item>
                           </el-col>
                           <el-col :span="6">
                             <el-form-item label="呼吸(次/min):" prop="th_huxi" >
                                <el-input v-model.number="tx_rec.th_huxi"  class="myInput" style="width:50px;">
                                </el-input>
                              </el-form-item>
                           </el-col>
                      </el-row>
                      <el-row>
                           ...
                           <el-col :span="12">
                             <el-form-item label="并发症:" >
                                <el-select multiple v-model="bingfazhengVal" clearable style="width: 300px" class="myInput" placeholder="请选择">
