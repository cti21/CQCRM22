    ...
    <div>
         <div>
            <el-card style="width: 90%;padding-left: 50px;">
              ...
              <el-table
                ...
                stripe>
                <el-table-column prop="tltype" label="通路分类" width="260" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="buwei" label="部位" width="180" align="center">
                </el-table-column>
                <el-table-column prop="material" label="材料" width="130" show-overflow-tooltip align="center">
                </el-table-column>
                <el-table-column prop="cewei" label="侧位" width="80" align="center">
                </el-table-column>
                <el-table-column prop="shoushudate" label="手术日期" width="140" align="center">
                </el-table-column>
                <el-table-column prop="usedate" label="首次使用" width="140" align="center">
                </el-table-column>
              </el-table>
            </el-card>
         </div>
         <div>
            <el-card style="width: 90%;padding-left: 50px;">
              ...
              <el-table
                ...
                <el-table-column prop="begindate" label="开始日期" width="180" :formatter="dateFormat">
                </el-table-column>
                <el-table-column prop="enddate" label="结束日期" width="180" :formatter="dateFormat">
                </el-table-column>
                <el-table-column prop="doctor" label="医生" width="120">
                </el-table-column>
                <el-table-column prop="content" label="事件描述" width="240" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="result" label="处理结果" width="240" show-overflow-tooltip>
                </el-table-column>
              </el-table>
            </el-card>
         </div>
         <div style="margin-top: 20px;">
           <el-dialog  title="血管通路" width="45%" :visible.sync="dialogFormVisible">
              ...
              <div slot="footer" class="dialog-footer">
                  ...
                  <el-button size="mini" type="primary" v-if="dialogStatus=='create'" @click="createData">新建</el-button>
                  <el-button size="mini" v-else type="primary" @click="updateData">修改</el-button>
              </div>
           </el-dialog>
         </div>
         ...
         <div style="margin-top: 20px;">
           <el-dialog  title="血管通路不良事件" width="45%" :visible.sync="adversedialogFormVisible">
              ...
              <div slot="footer" class="dialog-footer">
                  <el-button size="mini" @click="adversedialogFormVisible = false">取消</el-button>
                  <el-button size="mini" type="primary" v-if="adversedialogStatus=='create'" @click="adverse_createData">新建</el-button>
                  <el-button size="mini" v-else type="primary" @click="adverse_updateData">修改</el-button>
              </div>
           </el-dialog>
         </div>
