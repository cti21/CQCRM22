<template>
    <div>
        ...
        <div>
          <el-dialog  title="药品库存" width="60%" :visible.sync="dialogListVisible">
            ...
            <el-table
              ...
              <el-table-column prop="jiage" label="单价" width="80" align="center">
              </el-table-column>
              <el-table-column prop="kucun" label="库存数量"  width="80" align="center">
              </el-table-column>
              <el-table-column prop="firm" label="厂商" width="120" align="center">
              </el-table-column>
            </el-table>
            <div>
               ...
               <el-table
                 ...
                 stripe>
                  ...
                  <el-table-column prop="单位" label="单位" width="120" align="center">
                  </el-table-column>
                  <el-table-column prop="kucun" label="库存数量"  width="80" align="center">
                  </el-table-column>
                  <el-table-column prop="amount" label="出库数量" width="120" align="center">
...
<script>
import { createDrug, drugStocks_Person, createDrugStock, updateDrugStock, mydrugDict } from '@/api/login'
