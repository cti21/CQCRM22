<template>
    <div>
        <el-container>
          <el-aside id="personInfo" width="300px" style="background-color: #f0f2f5;padding: 0px 0px 0px 0px;display: block;">
              <div style="height:100%;background-color: #ffffff">
                  <el-row>
                    <label style="margin-left: 10px;font-size: small">患者列表</label>
                  </el-row>
                  <el-row style="margin-top:10px;">
                    <label style="margin-left: 10px;margin-right: 20px;font-size: small">就诊方式</label>
                    <el-button type="text" id="btn_clinic" style="margin-left: 20px">门诊</el-button>
                    <el-button type="text" id="btn_visit" style="margin-left: 20px">住院</el-button>
                  </el-row>
                  <el-row>
                    <label style="margin-left: 10px;margin-right: 20px;font-size: small">透析时间</label>
            ...
            <el-main style="margin-top: 0px;background-color: #f0f2f5">
              ...
              >
                ...
                <div style="margin-left: 10px;">
                  <personDrug :patientid="patientid">
                  </personDrug>
                </div>
              </div>
            </el-main>
...
import personDrug from '@/views/drug_person/drug.vue'
